document.addEventListener("DOMContentLoaded", () => {
        ...
        if (selectedMainCategory) {
            ...
            if (selectedMainCategory === "past") {
                ...
                subNodes = [
                    ...
                    { id: "pr_sync", label: "CORE SYNC", type: "usb_node", shape: "square", x: baseX - 120, y: baseY + 20, radius: 14, color: "#00f0ff", parent: "pr_root", desc: "Synchronization: 100% overlap with the master log." }
                ];
                ...
                subNodes = [
                    ...
                    { id: "f_collapse", label: "COLLAPSE SIM", type: "usb_node", shape: "circle", x: baseX - 140, y: baseY + 30, radius: 14, color: "#00f0ff", parent: "f_root", desc: "Risk of Collapse: Overlapping timelines." }
                ];
            }
        }
    ...
    function generateBackgroundBranches() {
        ...
        const mainOrigins = [
            { x: cx - width * 0.32, y: cy - height * 0.78 },
    ...
    canvas.addEventListener("click", () => {
        ...
        if (["past", "present", "future"].includes(hoveredNode.id)) {
            ...
            camera.targetY = (hoveredNode.y - 490) - height / 2;
